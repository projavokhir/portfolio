...
<div class="add-post">
	...
	<div class="form-wr">
			<label for="img_c_main">Изображение:<span class="req">*</span></label><br />
			<div class="inner">
				<input type="hidden" name="img" id="img_c_main" value="%img%" />
				<div class="find"> 
					<a href="/filemanager/dialog.php?type=1&field_id=img_c_main" class="cover_image_btn gallery fancy"></a>
					</div>
					<div class="img-block"><img src="%img%"></div>
			</div>
	</div>

		<div id="submit-wr">
			<input type="submit" value="Изменить" id="post_" name="edit_%b_name%">
		</div>
	</form>
</div>
